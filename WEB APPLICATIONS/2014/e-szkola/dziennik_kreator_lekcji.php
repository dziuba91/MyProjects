...
/*
$czas_S=array($godz_l_S[0]+$min_l_S[0]/100,
              $godz_l_S[1]+$min_l_S[1]/100,
              $godz_l_S[2]+$min_l_S[2]/100,
              $godz_l_S[3]+$min_l_S[3]/100,
              $godz_l_S[4]+$min_l_S[4]/100,
              $godz_l_S[5]+$min_l_S[5]/100,
              $godz_l_S[6]+$min_l_S[6]/100,
              $godz_l_S[7]+$min_l_S[7]/100);
              */
