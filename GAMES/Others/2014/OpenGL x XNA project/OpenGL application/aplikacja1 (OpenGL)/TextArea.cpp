...
TextArea::TextArea(FPS * fps1, TimeCounter * time1)
{
	oddalenie0 = -1.0f;
	maxWindow = 0.415f;
...
int TextArea::InitGL0(GLvoid)										// All Setup For OpenGL Goes Here
{
...
void TextArea::drawString0 (void * font, char * s, float x, float y, float z)
{
	unsigned int i, j;
	glRasterPos3f(x, y, z);
