...
namespace aplikacja2__XNA_.BasicComponent
{
    class RubikCubeHelper
    {
        ...
        public int [,] numb = {							 // Oznaczenie (numeracja) kwadracików 
						{1,1,2}, {1,1,0}, {1,1,1},
						{0,1,2}, {0,1,0}, {0,1,1},
						{2,1,2}, {2,1,0}, {2,1,1},
        ...
        bool wait4 = false;
        float max4 = 0.0f;
        public float speed4 = 0.4f;
        public float speed4_1 = 0.4f;
        public float speed4_2 = 0.0004f;

        int k;

        public float rotatuj = 5.0f;
        public float rotatuj_1 = 5.0f;
        public float rotatuj_2 = 0.5f;
        ...
        public void Rotate()
        {
            ...
            */
            ...
            if (trybObrotu4 == 0) { speed4 = 0.5f; max4 = 0.0f; wait4 = false; }
