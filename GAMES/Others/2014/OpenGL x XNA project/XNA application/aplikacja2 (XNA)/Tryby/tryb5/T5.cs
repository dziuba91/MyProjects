        ...
        public void Draw(GameTime gameTime, int[] fps0, int[] fps1, int[] fps2, int[] fps3, int[] fps4, int[] fps5)
        {
            ...
            for (j = 0; j < 100; j++)
            {
                ...
                else if (tryb == 1)
                {
                    ...
                    glVertex3f((j + 1) * 0.03f - 0.5f, skaluj(fpsArray1[j], max) + offset, 0.0f);//upper-right corner
                    glEnd();
                     * */
                }
                else if (tryb == 2)
                {
                    ...
                    /*
                    glBegin(GL_POINTS); //starts drawing of points
                    glVertex3f((j + 1) * 0.03f - 0.5f, skaluj(fpsArray2[j], max) + offset, 0.0f);//upper-right corner
                    glEnd();
                     * */
                }
                else if (tryb == 3)
                {
                    ...
                    /*
                    glBegin(GL_POINTS); //starts drawing of points
                    glVertex3f((j + 1) * 0.03f - 0.5f, skaluj(fpsArray3[j], max) + offset, 0.0f);//upper-right corner
                    glEnd();
                     * */
                }
                else if (tryb == 4)
                {
                    ...
                    /*
                    glBegin(GL_POINTS); //starts drawing of points
                    glVertex3f((j + 1) * 0.03f - 0.5f, skaluj(fpsArray4[j], max) + offset, 0.0f);//upper-right corner
                    glEnd();
                     * */
                }
                else if (tryb == 5)
                {
                    ...
                    /*
                    glBegin(GL_POINTS); //starts drawing of points
                    glVertex3f((j + 1) * 0.03f - 0.5f, skaluj(fpsArray5[j], max) + offset, 0.0f);//upper-right corner
                    glEnd();
                     * */
                }
                else if (tryb == 10)
		        {
			        ...
			        if (granica == 0)
			        {
				        ...
				        //pointY = skaluj(fps1[licznik],max) + offset;
			        }
			        else if (granica == 1)
			        {
