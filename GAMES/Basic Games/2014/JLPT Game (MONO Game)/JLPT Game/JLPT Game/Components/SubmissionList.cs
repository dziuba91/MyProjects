...
{
    class SubmissionList : DrawableGameComponent
    {
        #region Field
        ...
        public SubmissionOfKanji[] submission;
        public int[] submissionIndex;
        public int subMaxIndex;
        ...
        public SubmissionList(Game game)
            : base(game)
        {
        }
        ...
        public void Draw(GameTime gameTime, MouseState d, Vector2 position)
        {
            ...
            string test1 = submission[index].signs;
            string test2 = submission[index].reading;
            string test3 = submission[index].meaning;

            spriteBatch.Begin();

            //
            // actual index
            spriteBatch.DrawString(text2, (index + 1) + " / " + submission.Length, new Vector2(GraphicsDevice.Viewport.Width - 150, 10), Color.Black);
