...
namespace WpfApplication2
{
    public class KONTROLA_ROCHOW
    {
        ...
        {
            /*
                szkielet.Joints[JointType.Head], //0
                szkielet.Joints[JointType.HandLeft], //1
                szkielet.Joints[JointType.HandRight], //2
                szkielet.Joints[JointType.FootLeft], //3
                szkielet.Joints[JointType.FootRight], //4
                szkielet.Joints[JointType.HipCenter], //5
                szkielet.Joints[JointType.ShoulderCenter], //6
                szkielet.Joints[JointType.ElbowLeft], //7
                szkielet.Joints[JointType.ElbowRight] //8
             * */
