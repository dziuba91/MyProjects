...
import com.kandoumobile_v3.menu.kanji.SubmissionGameLayoutActivity;
import com.kandoumobile_v3.menu.kanji.SubmissionInfoLayoutActivity;
...
public class KanjiMenuLayoutActivity extends Activity {
	...
	public void getSub()
	{
		...
		SUB = new SubmissionOfKanji[arr.size()];
	...
	public void setLayoutContent()
	{
		...
		btn_3.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				startActivity(new Intent(KanjiMenuLayoutActivity.this, SubmissionGameLayoutActivity.class).putExtra("sub_data", SUB));
			}
		});
		...
		btn_4.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				startActivity(new Intent(KanjiMenuLayoutActivity.this, SubmissionInfoLayoutActivity.class).putExtra("sub_data", SUB).putExtra("index", 0));
			}
		});
	}
