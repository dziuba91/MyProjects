...
public class SubmissionGameLayoutActivity extends Activity {

	SubmissionOfKanji [] SUB = null;
	Activity app = null;
	
	SubmissionInfoLayoutActivity subInfo = null;
	...
	public void setLayoutContent()
	{
		...
		bG.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				startActivity(new Intent(SubmissionGameLayoutActivity.this, SubmissionInfoLayoutActivity.class).putExtra("sub_data", SUB).putExtra("index", bG_id));
			}
		});
		...
		bR.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				startActivity(new Intent(SubmissionGameLayoutActivity.this, SubmissionInfoLayoutActivity.class).putExtra("sub_data", SUB).putExtra("index", bR_id));
			}
		});
	...
	public void openLayoutActivity(SubmissionOfKanji [] sub)
    {
		this.SUB = sub;
