...
public class GUIClient extends JFrame implements ActionListener {
	...
	public GUIClient() {
		...
		urlTxtF = new JTextField(
				"http://app3.cc.puv.fi/e1401209_exam1_3/db_xmlrpc");
		...
		addToDataBaseButton.addMouseListener(new MouseListener(){
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try
				{
					queryResult = xmlrpcClient.executeInsertQuery(query, guestNameTxtF.getText(), commentTxtF.getText(), getDate);
				}
				catch (Exception e)
				{
				...
				if (queryResult == null) {
					...
					System.out.println("Insert query execution problem1!");
				...
				if (queryResult.equals("false")) {
					...
					System.out.println("Insert query execution problem2!");
